            ...
            <div className="container">
                <div className="about-grid">
                    ...
                    <div className="ta-end">
                        ...
                        <ol>
                            <li>create a room</li>
                            <li>share the room number with a friend</li>
                            <li>upload an .mp3 or two</li>
                            <li>hit play</li>
                        </ol>
                    </div>
                    ...
                    <p>
                        ...
                        too. pause, and it pauses for everyone in the room.
                    ...
                    <p>
                        it's time to share your passion with the world. get out
                        there, and tell them what you think
                    </p>
                </div>
            </div>
        </div>
